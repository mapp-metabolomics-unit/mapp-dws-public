...
For 1.0 L of ACN:H₂O 60:40 (v/v), containing 10 mM ammonium formate and 0.1% formic acid, use:
600 mL acetonitrile
400 mL water
0.631 g ammonium formate
10 mmol×63.06 g mol 
−1
 =0.6306 g
1.00 mL neat formic acid for 0.1% v/v
Procedure
Place approximately 350 mL LC–MS-grade water in a clean glass bottle or graduated cylinder.
Add 0.631 g ammonium formate and mix until completely dissolved.
In a fume hood, add 1.00 mL formic acid and mix.
Add additional water to bring this aqueous solution to 400 mL.
Add 600 mL LC–MS-grade acetonitrile.
Mix thoroughly.
This gives the nominal mobile-phase composition:
ACN:H 
2
​	
 O=60:40,[NH 
...
For LC–MS use, prepare it in clean glassware, cap it promptly, and label it with the composition and preparation date. Filtering is usually unnecessary with clean LC–MS-grade reagents, but the aqueous portion can be filtered through a compatible 0.2 µm membrane before adding ACN when required by your laboratory procedure.